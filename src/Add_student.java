...
public class Add_student extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(dob.isEmpty()||name.isEmpty()||urn.isEmpty()||course.isEmpty()||semester.isEmpty()||email.isEmpty()||mno.isEmpty())
        {
            JOptionPane.showMessageDialog(this,"Please enter all the details properly.");
        }
        else
        {
            if(urn  == null ? urn != null : !urn.equals(urn))
            {
                JOptionPane.showMessageDialog(this,"Please enter the URN again.");
            }
            else
            {
                try
                {
                    ...
                    String query="Insert Into student_details values ('"+name+"','"+dob+"','"+urn+"','"+course+"','"+semester+"','"+email+"','"+mno+"');";
